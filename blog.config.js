const BLOG = {
  title: "Whites Space",
  author: "Clu Soh",
  email: "clu@whites.space",
  link: "https://whites.space",
  description:
    "A Blog and Site about CLU thoughts and recording my experience that worth to share.",
  lang: "en-US", // ['en-US', 'zh-CN', 'zh-HK', 'zh-TW', 'ja-JP']
  appearance: "auto", // ['light', 'dark', 'auto'],
  font: "sans-serif", // ['sans-serif', 'serif']
  lightBackground: "#ededed", // use hex value, don't forget '#' e.g #fffefc
  darkBackground: "#232323", // use hex value, don't forget '#'
